...
class ArduinoPeripheral{
     ...
     */
    setUnoStartDigitalOutput (pin, level) {
        if (this.isReady()) {
            pin = this.parsePin(pin);
     ...
     */
     setUnoStartPwmOutput (pin, value) {
        if (this.isReady()) {
            pin = this.parsePin(pin);
            if (value < 0) {
                value = 0;
     ...
     */
     setUnoStartServoOutput (pin, value) {
        if (this.isReady()) {
            pin = this.parsePin(pin);
            if (value < 0) {
                value = 0;
